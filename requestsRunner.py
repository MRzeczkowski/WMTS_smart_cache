...
if __name__ == '__main__':
    ...
    files = [
        '/Users/mateusz/Documents/projects/WMTS_smart_cache/statistics/getTileStatistics_2022-12-03 17:47:47.978605.csv'
    ]
    ...
    for file in files:
        ...
        for index, row in df.iterrows():
            ...
            if not lastRequestedTime == 0:
                waitTime = min(abs(currentRequestedTime - lastRequestedTime), random.randint(2, 3) * 60)
